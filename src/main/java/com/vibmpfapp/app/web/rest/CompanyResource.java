...
import com.vibmpfapp.app.domain.Company;
import com.vibmpfapp.app.repository.CompanyRepository;
...
/**
 * REST controller for managing {@link com.vibmpfapp.app.domain.Company}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Company> result = companyRepository
            ...
            .map(existingCompany -> {
                ...
                if (company.getVideo() != null) {
                    existingCompany.setVideo(company.getVideo());
                }
                if (company.getVideoContentType() != null) {
                    existingCompany.setVideoContentType(company.getVideoContentType());
                }
