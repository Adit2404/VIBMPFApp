...
/**
 * REST controller for managing {@link com.vibmpfapp.app.domain.Experience}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ExperienceResource {
    ...
    public ResponseEntity<Experience> updateExperience(
        ...
        experience.setIsPersisted();
        Experience result = experienceRepository.save(experience);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, experience.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Experience> partialUpdateExperience(
        ...
        Optional<Experience> result = experienceRepository
            ...
            .map(existingExperience -> {
                ...
                if (experience.getSdate() != null) {
                    existingExperience.setSdate(experience.getSdate());
                }
                if (experience.getEdate() != null) {
                    existingExperience.setEdate(experience.getEdate());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, experience.getId())
        );
    }
